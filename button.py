...
class Button:
    def __init__(self, ai_game, screen, msg):
        ...
        # Define the size and properties of the button.
    ...
    def _prep_msg(self, msg):
        """Place the message in the generated image and center the text on the button."""
        self.msg_image = self.font.render(msg, True, self.text_color, self.button_color)
        self.msg_image_rect = self.msg_image.get_rect()
        self.msg_image_rect.center = self.rect.center

    def draw_button(self):
        # Display a blank button and then a message on it.
